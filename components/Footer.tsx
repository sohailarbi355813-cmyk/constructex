...
export default function Footer() {
  ...
  return (
    <footer className="relative py-16 px-6 border-t border-white/5 overflow-hidden">
      {/* Subtle glow */}
      <div className="absolute inset-x-0 bottom-0 h-48 bg-gradient-to-t from-[#111111] to-transparent pointer-events-none" />
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/50">
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 text-[#686B6C]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-start gap-2">
                <svg className="w-4 h-4 text-[#686B6C] mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
